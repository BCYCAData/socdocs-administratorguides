<script>
	...
	const navbar = {
		links: [
			{ title: 'Community Administration', slug: '/community-admin', match: /\/community-admin/ },
			{ title: 'User Administration', slug: '/user-admin', match: /\/user-admin/ },
			{ title: 'Database Administration', slug: '/db-admin', match: /\/db-admin/ },
			{ title: 'Site Administration', slug: '/site-admin', match: /\/site-admin/ }
		]
	};
